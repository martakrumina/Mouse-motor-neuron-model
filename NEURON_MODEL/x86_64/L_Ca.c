...
#define nrn_init _nrn_init__L_Ca
#define _nrn_initial _nrn_initial__L_Ca
#define nrn_cur _nrn_cur__L_Ca
#define _nrn_current _nrn_current__L_Ca
#define nrn_jacob _nrn_jacob__L_Ca
#define nrn_state _nrn_state__L_Ca
#define _net_receive _net_receive__L_Ca 
#define evaluate_fct evaluate_fct__L_Ca 
#define states states__L_Ca 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_L_Ca", _hoc_setdata,
 "Exp_L_Ca", _hoc_Exp,
 "evaluate_fct_L_Ca", _hoc_evaluate_fct,
 "vtrap_L_Ca", _hoc_vtrap,
 0, 0
};
#define Exp Exp_L_Ca
#define vtrap vtrap_L_Ca
 extern double Exp( _threadargsprotocomma_ double );
 extern double vtrap( _threadargsprotocomma_ double , double );
 /* declare global and static user variables */
#define kappa_m kappa_m_L_Ca
 double kappa_m = -6;
#define tau_m tau_m_L_Ca
 double tau_m = 20;
#define theta_m theta_m_L_Ca
 double theta_m = -30;
#define vca vca_L_Ca
 double vca = 80;
 ...
 "tau_m_L_Ca", &tau_m_L_Ca,
 "vca_L_Ca", &vca_L_Ca,
 "theta_m_L_Ca", &theta_m_L_Ca,
 "kappa_m_L_Ca", &kappa_m_L_Ca,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 L_Ca /home/user/Desktop/Mouse-motor-neuron-model-main/MouseNEURON/L_Ca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/user/Desktop/Mouse-motor-neuron-model-main/MouseNEURON/L_Ca.mod";
static const char* nmodl_file_text = 
